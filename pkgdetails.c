/**
 * This file was copied out of jolicloud's base-installer git repo.
 * It is Debian code.
 * Since I can't find the fucking debian source with just Googling the file name, this warning is the most gratitude the copyright holder gets without someone telling me what to put here.
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
